...
export const AGY_PUBLIC_MODELS = Object.freeze([
  ...
  },
  {
    ...
    name: "Claude Opus 4.6 (Thinking High)",
    contextLength: 1048576,
    maxOutputTokens: 65536,
    supportsReasoning: true,
    supportsVision: true,
    toolCalling: true,
    liveCatalogIds: ["claude-opus-4-6-thinking"],
  },
  {
    id: "claude-opus-4-6-thinking-medium",
    name: "Claude Opus 4.6 (Thinking Medium)",
    contextLength: 1048576,
    maxOutputTokens: 65536,
    supportsReasoning: true,
    supportsVision: true,
  ...
  },
  {
    ...
    supportsVision: true,
    toolCalling: true,
    liveCatalogIds: ["claude-sonnet-4-6"],
  },
  {
